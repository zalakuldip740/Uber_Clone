                  ...
                  child: BlocBuilder<UserReqCubit, UserReqState>(
                    builder: (context, state) {
                      if (state is UserReqInitial) {
                        ...
                        //draw route of trip
                        BlocProvider.of<UberMapCubit>(context).drawRoute(state);
                        ...
                        return Container(
                          ...
                          child: ListTile(
                              ...
                              children: [
                                ...
                                CustomElevatedButton(
                                  onPressed: () {
                                    ...
                                    if (state.tripDriver.tripHistoryModel
                                    ...
                                    } else if (state.tripDriver.tripHistoryModel
                                                .isCompleted ==
                                            true &&
                                      ...
                                      //fetch continous trips while one trip is accepted
                                      BlocProvider.of<UserReqCubit>(context)
                                          .isAccept(
                                              state.tripDriver, false, false);
                                    }
                            ...
                            leading: Text(
                                '${state.tripDriver.tripHistoryModel.tripAmount} \u{20B9}',style: const TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 16
                            ),),
                            trailing: GestureDetector(
                              onTap: () async {
                                String? number = state.tripDriver.riderModel.mobile;
